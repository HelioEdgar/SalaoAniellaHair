    ...
    <div class="col-md-12 col-xl-12 middle-wrapper">
        <div class="row">
            <div class="card">
                ...
                <form method="POST" action="{{ route('actualizar.galeria') }}" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="nome" type="text" name="nome" class="form-control text-white ps-1 @error('nome') is-invalid @enderror" value="{{ $galerias->nome }}">
                        @error('nome')
            ...
            @endforeach
                    ...
                    <a id="delete" class="btn btn-danger" href="{{ route('apagar.galeria',$galerias->id) }}">Apagar Foto</a>
                </form>
