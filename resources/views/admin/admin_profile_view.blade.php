      ...
      <div class="card rounded">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-2">
            <div>
                <img class="rounded-circle" width="128" height="128" src="{{ (!empty($profileData->foto)) ? url('upload/admin_imagens/'.$profileData->foto) : url('upload/no_image.jpg') }}" alt="profile">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control text-white ps-1 " id="exampleFormControlTextarea1" rows="5">{{ $profileData->sobre }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <img id="showImage" class="rounded-circle" width="80" height="80" src="{{ (!empty($profileData->foto)) ? url('upload/admin_imagens/'.$profileData->foto) : url('upload/no_image.jpg') }}" alt="profile">
                    </div>
