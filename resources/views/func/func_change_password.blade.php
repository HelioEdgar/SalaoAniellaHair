      ...
      <div class="card rounded">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-2">
            <div>
                <img class="rounded-circle" width="128" height="128" src="{{ (!empty($profileData->foto)) ? url('upload/func_images/'.$profileData->foto) : url('upload/no_image.jpg') }}" alt="profile">
    ...
    <div class="col-md-8 col-xl-8 middle-wrapper">
        <div class="row">
            <div class="card">
                ...
                <form method="POST" action="{{ route('func.update.password') }}" class="forms-sample" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
